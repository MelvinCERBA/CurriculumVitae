...
export class FromGroundUp1722719143524 implements MigrationInterface {
    name = 'FromGroundUp1722719143524'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`tag\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`slug\` varchar(255) NOT NULL, \`aliasForId\` int NULL, \`categoryId\` int NULL, UNIQUE INDEX \`IDX_6a9775008add570dc3e5a0bab7\` (\`name\`), UNIQUE INDEX \`IDX_3413aed3ecde54f832c4f44f04\` (\`slug\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
